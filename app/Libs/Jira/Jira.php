...
class Jira
{
	...
	public static function GetSprint($sprintid,$timezone=null)
	{
		try
		{
			$sprint= self::$sprintService->getSprint($sprintid);
			$sprint->startDate = CDateTime(strtotime($sprint->startDate),$timezone)->getTimeStamp();
			$sprint->endDate = CDateTime(strtotime($sprint->endDate),$timezone)->getTimeStamp();
			$sprint->completeDate = CDateTime(strtotime($sprint->completeDate),$timezone)->getTimeStamp();
			return $sprint;
